...
class PodcastRecommender:
    ...
    def fetch_categories(self):
        """
        Fetch available podcast categories from the Spotify API.
        """
...
if __name__ == "__main__":
    ...
    # Fetch and display podcast categories
    categories = podcast_recommender.fetch_categories()
    if categories:
        print("Available Podcast Categories:")
        for cat_id, cat_name in categories:
            print(f"{cat_name} (ID: {cat_id})")
    
    # Get podcast recommendations
    podcast_title = "Bhagavad Gita"  
